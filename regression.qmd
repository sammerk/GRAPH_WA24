...
## Datengrundlage
Wir werden in diesen Workshop mit den Scientific Usefiles des STAR-Projektes [@achilles1985] arbeiten. Im STAR-Projekt wurde u.a. die die Klassenzusammensetzung und die Klassengröße randomisiert bestimmt um so kausale Effekte der Klassengröße auf die schulische Leistung untersuchen zu können. Ein `.sav`-file das selektierte Variablen enthält, kann `r xfun::embed_file("data/data_star_selected_variables.sav", "data_star_selected_variables.sav", "hier")` heruntergeladen werden.
:::
