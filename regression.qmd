...
# Aggregate classes according g3
data_star_sampled <- 
    data_star_selected_variables |> 
    group_by(g3tchid) |> 
    sample_n(1) |> 
...
#### Plot
In einem ersten Schritt (der ganz generell im zu empfehlen ist) plotten wir die Rohdaten. Um keine Probleme mit geclusterten Daten zu bekommen, verwenden wir aus jeder Klasse nur eine:n zufällig gezogenen Schüler:in. 
